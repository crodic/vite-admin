    ...
    <Main className='flex flex-1 flex-col gap-4 sm:gap-6'>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t('pages.adminUsers.edit.title')}</CardTitle>
              <CardDescription>
                {t('pages.adminUsers.edit.description')}
              </CardDescription>
            </CardHeader>
            <CardContent className='mt-4 flex flex-col gap-4 sm:gap-8 md:grid md:grid-cols-3'>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel required>
                      {t('pages.adminUsers.edit.fields.firstName')}
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel required>
                      {t('pages.adminUsers.edit.fields.lastName')}
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t('pages.adminUsers.edit.fields.phoneNumber')}
                    </FormLabel>
                    <FormControl>
                      <PhoneInput
                        placeholder={t(
                          'pages.adminUsers.edit.fields.phoneNumberPlaceholder'
                        )}
                        defaultCountry='VN'
                        international
                        {...field}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t('pages.adminUsers.edit.fields.birthday')}
                    </FormLabel>
                    <FormControl>
                      <DatePickerForm
                        placeholder={t(
                          'pages.adminUsers.edit.fields.birthdayPlaceholder'
                        )}
                        field={field}
                        disabled={(date: Date) =>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel required>
                      {t('pages.adminUsers.edit.fields.role')}
                    </FormLabel>
                    <FormControl>
              ...
              <div className='col-span-3'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t('pages.adminUsers.edit.fields.bio')}
                      </FormLabel>
                      <FormControl>
                        <Textarea
                          placeholder={t(
                            'pages.adminUsers.edit.fields.bioPlaceholder'
                          )}
