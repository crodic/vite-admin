      ...
      <Main className='flex flex-1 flex-col gap-4 sm:gap-6'>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
            <div className='mb-2 flex flex-col items-baseline justify-between space-y-2 sm:flex-row sm:items-center'>
              <div className='flex flex-row space-x-2'>
                <h2 className='text-2xl font-bold tracking-tight'>
                  {t('pages.adminUsers.create.title')}
                </h2>
              </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('pages.adminUsers.create.title')}</CardTitle>
                <CardDescription>
                  {t('pages.adminUsers.create.description')}
                </CardDescription>
              </CardHeader>
              <CardContent className='mt-4 flex flex-col gap-4 sm:gap-8 md:grid md:grid-cols-3'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required>
                        {t('pages.adminUsers.create.fields.email')}
                      </FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required>
                        {t('pages.adminUsers.create.fields.firstName')}
                      </FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required>
                        {t('pages.adminUsers.create.fields.lastName')}
                      </FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t('pages.adminUsers.create.fields.phoneNumber')}
                      </FormLabel>
                      <FormControl>
                        <PhoneInput
                          placeholder={t(
                            'pages.adminUsers.create.fields.phoneNumberPlaceholder'
                          )}
                          defaultCountry='VN'
                          international
                          {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t('pages.adminUsers.create.fields.birthday')}
                      </FormLabel>
                      <FormControl>
                        <DatePickerForm
                          placeholder={t(
                            'pages.adminUsers.create.fields.birthdayPlaceholder'
                          )}
                          field={field}
                          disabled={(date: Date) =>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required>
                        {t('pages.adminUsers.create.fields.password')}
                      </FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required>
                        {t('pages.adminUsers.create.fields.confirmPassword')}
                      </FormLabel>
                      <FormControl>
                        <PasswordInput placeholder='*******' {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required>
                        {t('pages.adminUsers.create.fields.role')}
                      </FormLabel>
                      <FormControl>
                ...
                <div className='col-span-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t('pages.adminUsers.create.fields.bio')}
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            {...field}
                            value={field.value ?? ''}
                            placeholder={t(
                              'pages.adminUsers.create.fields.bioPlaceholder'
                            )}
                          ></Textarea>
                        </FormControl>
                        <FormMessage />
